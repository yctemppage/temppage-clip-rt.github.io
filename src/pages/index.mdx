    ...
    <div class="container">
      <div class="video-group">
        <Figure caption="Close the laptop">
          <Video source={close_the_laptop} autoplay={false} />
        </Figure>
        <Figure caption="Draw a line">
          <Video source={draw_a_line} autoplay={false} />
        </Figure>
        <Figure caption="Erase the whiteboard">
          <Video source={erase_the_whiteboard} autoplay={false} />
        </Figure>
        <Figure caption="Hide the Pooh">
          <Video source={hide_the_pooh} autoplay={false} />
        </Figure>
        <Figure caption="Open the cabinet">
          <Video source={open_the_cabinet} autoplay={false} />
        </Figure>
        <Figure caption="Open the trashcan">
          <Video source={open_the_trashcan} autoplay={false} />
        </Figure>
        <Figure caption="Play with the car">
          <Video source={play_with_car} autoplay={false} />
        </Figure>
        <Figure caption="Pour the dog food">
          <Video source={pour_the_dog_food} autoplay={false} />
        </Figure>
        <Figure caption="Stamp">
          <Video source={stamp} autoplay={false} />
        </Figure>
      </div>
    </div>
  </div>
