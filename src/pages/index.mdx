...
<section class>
  <div class="box" style="background-color: #f5f5f5; border-left: 4px solid #3273dc; padding: 10px; font-size: 0.5rem;">
      ...
      <p>We enable robots to learn end-to-end policies only through natural language supervision.</p>
      <p>Our VLA model learns robotic skills directly from this supervision.</p>
  </div>
</section>
