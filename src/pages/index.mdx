      ...
      >
        <SwiperSlide>
          <div class="video-group">
            <Video source="../assets/videos/videos/close_the_laptop.mp4" caption="Close the laptop" />
            <Video source="../assets/videos/videos/draw_a_line.mp4" caption="Draw a line" />
            <Video source="../assets/videos/videos/erase_the_whiteboard.mp4" caption="Erase the whiteboard" />
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div class="video-group">
            <Video source="../assets/videos/videos/hide_the_pooh.mp4" caption="Hide the Pooh" />
            <Video source="../assets/videos/videos/open_the_cabinet.mp4" caption="Open the cabinet" />
            <Video source="../assets/videos/videos/open_the_trashcan.mp4" caption="Open the trashcan" />
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div class="video-group">
            <Video source="../assets/videos/videos/play_with_car.mp4" caption="Play with the car" />
            <Video source="../assets/videos/videos/pour_the_dog_food.mp4" caption="Pour the dog food" />
            <Video source="../assets/videos/videos/stamp.mp4" caption="Stamp" />
          </div>
        </SwiperSlide>
      </Swiper>
    </div>
