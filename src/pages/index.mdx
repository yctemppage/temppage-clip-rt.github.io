      ...
      >
        <SwiperSlide>
          <div class="video-group">
            <Video source="/static/videos/close_the_laptop.mp4" />
            <Video source="/static/videos/draw_a_line.mp4" />
            <Video source="/static/videos/erase_the_whiteboard.mp4" />
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div class="video-group">
            <Video source="/static/videos/hide_the_pooh.mp4" />
            <Video source="/static/videos/open_the_cabinet.mp4" />
            <Video source="/static/videos/open_the_trashcan.mp4" />
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div class="video-group">
            <Video source="/static/videos/play_with_car.mp4" />
            <Video source="/static/videos/pour_the_dog_food.mp4" />
            <Video source="/static/videos/stamp.mp4" />
          </div>
        </SwiperSlide>
      </Swiper>
    </div>
