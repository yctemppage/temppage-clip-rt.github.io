  ...
  <div class="hero-body">
    <div class="container">
      <div class="video-group">
        ...
        <Figure caption="Draw a line from the circle to the star">
...
<section class>
  <div class="box" style="background-color: #f5f5f5; border-left: 4px solid #3273dc; padding: 10px; font-size: 0.5rem;">
      ...
      <p>We study how non-experts train robotic skills only through natural language supervision.</p>
      <p>We propose a new VLA model, CLIP-RT that learns end-to-end policies directly from this supervision.</p>
  </div>
</section>
