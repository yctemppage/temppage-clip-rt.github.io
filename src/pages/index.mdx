    ...
    <div class="container">
      <div class="video-group">
        <Figure caption="Close the laptop">
          <Video source={close_the_laptop} autoplay={true} muted={true} />
        </Figure>
        <Figure caption="Draw a line">
          <Video source={draw_a_line} autoplay={true} muted={true} />
        </Figure>
        <Figure caption="Erase the whiteboard">
          <Video source={erase_the_whiteboard} autoplay={true} muted={true} />
        </Figure>
        <Figure caption="Hide the Pooh">
          <Video source={hide_the_pooh} autoplay={true} muted={true} />
        </Figure>
        <Figure caption="Open the cabinet">
          <Video source={open_the_cabinet} autoplay={true} muted={true} />
        </Figure>
        <Figure caption="Open the trashcan">
          <Video source={open_the_trashcan} autoplay={true} muted={true} />
        </Figure>
        <Figure caption="Play with the car">
          <Video source={play_with_car} autoplay={true} muted={true} />
        </Figure>
        <Figure caption="Pour the dog food">
          <Video source={pour_the_dog_food} autoplay={true} muted={true} />
        </Figure>
        <Figure caption="Stamp">
          <Video source={stamp} autoplay={true} muted={true} />
        </Figure>
      </div>
    </div>
  </div>
