      ...
      >
        <SwiperSlide>
          <div class="video-group">
            <Video source="./static/videos/close_the_laptop.mp4" caption="Close the laptop" />
            <Video source="./static/videos/draw_a_line.mp4" caption="Draw a line" />
            <Video source="./static/videos/erase_the_whiteboard.mp4" caption="Erase the whiteboard" />
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div class="video-group">
            <Video source="./static/videos/hide_the_pooh.mp4" caption="Hide the Pooh" />
            <Video source="./static/videos/open_the_cabinet.mp4" caption="Open the cabinet" />
            <Video source="./static/videos/open_the_trashcan.mp4" caption="Open the trashcan" />
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div class="video-group">
            <Video source="./static/videos/play_with_car.mp4" caption="Play with the car" />
            <Video source="./static/videos/pour_the_dog_food.mp4" caption="Pour the dog food" />
            <Video source="./static/videos/stamp.mp4" caption="Stamp" />
          </div>
        </SwiperSlide>
      </Swiper>
    </div>
